...
```sql
select BIN(f1),BIN(f2),BIN(f3) from test_bit1;
+---------+---------+---------+
| BIN(f1) | BIN(f2) | BIN(f3) |
+---------+---------+---------+
| 1       | NULL    | NULL    |
| 1       | NULL    | NULL    |
| NULL    | 10111   | NULL    |
...
```sql
 select HEX(f1),HEX(f2),HEX(f3) from test_bit1;
+---------+---------+---------+
...
```sql
insert into test_year values(2020,1900);
...
```sql
insert into test_year values(69, 70);
select * from test_year;
+------+------+
| f1   | f2   |
+------+------+
...
INSERT INTO test_time1 VALUES('12:35:29');
INSERT INTO test_time1 VALUES('12:40');
INSERT INTO test_time1 VALUES('2 12:40');
INSERT INTO test_time1 VALUES('1 05');
INSERT INTO test_time1 VALUES('45');
INSERT INTO test_time1 VALUES('123520');
INSERT INTO test_time1 VALUES(124011);
...
```sql
INSERT INTO test_datetime1 VALUES ('2021-01-01 06:50:30');
INSERT INTO test_datetime1 VALUES ('20210101065030');

INSERT INTO test_datetime1 VALUES ('99-01-01 00:00:00');
INSERT INTO test_datetime1 VALUES ('990101000000');
INSERT INTO test_datetime1 VALUES ('200101000000');
INSERT INTO test_datetime1 VALUES ('20-01-01 00:00:00');

INSERT INTO test_datetime1 VALUES (20200101000000);
INSERT INTO test_datetime1 VALUES (200101000000);
INSERT INTO test_datetime1 VALUES (19990101000000);
INSERT INTO test_datetime1 VALUES (990101000000);
...
* TIMESTAMP和时区有关。TIMESTAMP会根据用户的时区不同，显示不同的结果。而DATETIME则只能反映出插入时当地的时区，其他时区的人查看数据必然会有误差的。
  ...
  | 2022-05-02 03:30:58 | 2022-05-02 03:30:58 |
  +---------------------+---------------------+
  2 rows in set (0.00 sec)
  ```
  ...
  | 2022-05-02 03:30:58 | 2022-05-02 04:30:58 |
  +---------------------+---------------------+
  2 rows in set (0.00 sec)
  ```
...
![image-20220502033549747](images/image-20220502033549747.png)
...
```sql
SELECT LENGTH(f1),LENGTH(f2),LENGTH(f4) FROM test_binary1;
+------------+------------+------------+
| LENGTH(f1) | LENGTH(f2) | LENGTH(f4) |
+------------+------------+------------+
|          1 |          3 |       NULL |
|          1 |          3 |       NULL |
|       NULL |          3 |          2 |
...
* Geometry是所有空间集合类型的基类，其他类型如POINT、LINESTRING、POLYGON都是Geometry的子类。
  ...
  * Polygon，多边形。可以是一个实心平面形，即没有内部边界，也可以有空洞，类似纽扣。最简单的就是只有一个外边界的情况，例如POLYGON((0 0,10 0,10 10, 0 10))。
    ...
    ![image-20220502222800703](images/image-20220502222800703.png)

* MultiPoint、MultiLineString、MultiPolygon、GeometryCollection 这4种类型都是集合类，是多个Point、LineString或Polygon组合而成。

下面展示的是多个同类或异类几何图形元素的组合：

![image-20220502222809621](images/image-20220502222809621.png)
