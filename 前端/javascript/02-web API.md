...
<script>
  ...
  const repeatId = setInterval(repeat, 1000)
</script>
```

`clearInterval` 用于取消定时器
...
- window对象下的属性和方法调用的时候可以省略window
 ...
 ![67604743636](images/1676047436362.png)
...
replace 替换方法，可以完成字符的替换
 ...
 ![67608043716](images/1676080437160.png)
...
### 正则插件
 ...
 ![67608054863](images/1676080548639.png)
